...
class _AlertDetailPage extends State<AlertDetailPage> {
  ...
  void _activateMotionListeners() {
    _deterrentStream = _database.child('PIR_STATUS').onValue.listen((event) {
      final Object? motion = event.snapshot.value;
      setState(() {
        _displayMotion = '$motion';
      });
    });
  }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 12),
                      Text("Motion Sensor: " + _displayMotion, style: body1),
                      SizedBox(height: 30),
